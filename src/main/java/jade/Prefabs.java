...
public class Prefabs {
    ...
    public static GameObject generateMario() {
        ...
        Spritesheet bigPlayerSprites = AssetPool.getSpritesheet("asset/images/bigSpritesheet.png");
    ...
    public static GameObject generateGoomba(){
        Spritesheet sprites = AssetPool.getSpritesheet("asset/images/spritesheet.png");
    ...
    public static GameObject generateTurtle(){
        Spritesheet turtleSprites = AssetPool.getSpritesheet("asset/images/turtle.png");
